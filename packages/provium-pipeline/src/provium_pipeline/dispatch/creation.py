...
from provium_pipeline.dispatch.models import CreateDispatchRequest, Dispatch
from provium_pipeline.dispatch.planning import plan_dispatch
...
class DispatchCreationService:
    ...
    def __init__(
        ...
        *,
        ...
        node_labels: Callable[[RunId], Mapping[str, frozenset[str]]] = _no_node_labels,
    ) -> None:
